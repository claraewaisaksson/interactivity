...
let intervalMeter = new IntervalMeter(5, 400);
...
function analyse() {
  ...
  //adjusted the frequency treshold to match the pitch of the metronome
...
function updateDisplay() {
  ...
  //We wanted something to show when BPM hits 100, so we decided to go with an image of a balloon just to try it out
  //Had to make the code be okay with either 99 or 100 because it's a bit unstable
  if(currentBpm == 99 || currentBpm == 100) {
